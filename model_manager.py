...
def parallel_gibbs(models=None, melody=None, chorale_metas=None,
    ...
    #f1 = 'E:\zr\deepbach/new_dataset/note2indexes/note2indexes.pickle'
    #pickle.dump(note2indexes, open(f1, 'wb'))
    #f2 = 'E:\zr\deepbach/new_dataset/index2notes/index2notes.pickle'
    #pickle.dump(index2notes, open(f2, 'wb'))
    #f3 = 'E:\zr\deepbach/new_dataset/X/X.pickle'
    #pickle.dump(X, open(f3, 'wb'))
    #f4 = 'E:\zr\deepbach/new_dataset/metadatas/metadatas.pickle'
    #pickle.dump(metadatas, open(f4, 'wb'))
    ...
    for iteration in tqdm(range(num_iterations)):
        ...
        for voice_index in range(min_voice, num_voices):
            ...
            # 将输入字典保存起来
            #file = open('E:\zr\deepbach\DeepBach-master-gpu-58\pickle_input_feature.pickle', 'wb')
            #pickle.dump(batch_input_features, file)
            #file.close()
